 ...
 */
final class Version20251026123454 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE email_confirmation DROP confirmed_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE email_confirmation ADD confirmed_at DATETIME DEFAULT NULL');
    }
}
